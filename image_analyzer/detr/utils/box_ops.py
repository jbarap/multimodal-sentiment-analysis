...
From the original Facebook DETR repo.
"""
import torch
...
def box_cxcywh_to_xyxy(x):
    # unbind removes one dimension of size n and returns a list with n items of tensors
    # without tht dimension, in this case it converts a matrix of N size 4 vectors
    # to 4 tensors of size N by 1
